...
pub static SUFFIX_MAP: Lazy<HashMap<&'static str, &'static [u32]>> = Lazy::new(|| {
    ...
    m.insert("psop", &[1]);
    m.insert("sdf", &[0x7db96331, 0x77de5a9e, 0x77da5e9d, 0x77a4cbdd]); //PC, nswLastest, nswDemo2, nswDemo1
    m.insert("mmtr", &[0x7db96331, 0x77de5a9e, 0x77da5e9d, 0x77a4cbdd]);
    m.insert("mmtrs", &[0x7db96331, 0x77de5a9e, 0x77da5e9d, 0x77a4cbdd]);
    m.insert("vsdf", &[0x7db96332, 0x77de5a9f, 0x77da5e9e, 0x77a4cbde]);
    m.insert("tex", &[0x1c]);
    m.insert("rtex", &[5, 152]); //demo nsw&PC
    m.insert("rcfg", &[3]);
    m.insert("sss", &[2]);
    m.insert("lod", &[3]);
    m.insert("rtmr", &[3]);
